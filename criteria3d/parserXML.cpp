...
bool parseXMLFile(Crit3DProject* myProject, QString xmlFileName, QDomDocument* myDocument)
{
    if (xmlFileName == "")
    {
   ...
   while(!ancestor.isNull())
   {
       ...
       else if (ancestor.toElement().tagName().toUpper() == "GEO")
       {
           ...
           while( !child.isNull())
           {
               ...
               else if ((myTag == "EMISPHERE"))
                    {myProject->gisSettings.isNorthernEmisphere = !(child.toElement().text().toUpper() == "SOUTH");}
