...
{
    SettingsDialog* mySettingsDialog = new SettingsDialog(myProject.pathSettings, myProject.parameters, &myProject.gisSettings, myProject.quality, myProject.meteoSettings);
