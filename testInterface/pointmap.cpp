...
PointMap::PointMap(QWidget *parent) :
    MapGraphicsView(0, parent)
{
}

PointMap::PointMap(MapGraphicsScene *scene, QWidget *parent) :
...
void PointMap::handleChildMousePress(QMouseEvent *event)
{
...
//protected slot
//virtual from MapGraphicsView
void PointMap::handleChildMouseRelease(QMouseEvent *event)
{
    if (event->button() != Qt::LeftButton)
        return;
    /*
