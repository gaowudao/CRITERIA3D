...
#define SOILFLUXES3D
    ...
    __EXTERN int DLL_EXPORT __STDCALL initialize(long nrNodes, int nrLayers, int nrLateralLinks, bool comuteWater_, bool computeHeat_, bool computeSolutes_, bool computeHeatLatent_, bool computeHeatAdvective_);
    ...
    __EXTERN int DLL_EXPORT __STDCALL SetHeatBoundaryHeight(long nodeIndex, double myHeight);
    ...
    __EXTERN double DLL_EXPORT __STDCALL getHeat(long nodeIndex, double theta);
