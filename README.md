...
CRITERIA3D distribution uses Qt libraries. Qt 5.7 or following is needed. GUI executables (CRITERIA3D, VINE3D, PRAGA and HEAT1D) need MapGraphics library and a configuration file (default.ini), see [PRAGA wiki](https://github.com/ARPA-SIMC/CRITERIA3D/wiki/PRAGA) for more informations. 
