...
QT_MOC_LITERAL(5, 48, 5) // "reply"
    ...
    "Download\0finished\0\0QNetworkReply*\0"
    "replyFinished\0reply"
};
...
void Download::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Download::*_t)(QNetworkReply * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Download::finished)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Download::finished(QNetworkReply * _t1)
{
