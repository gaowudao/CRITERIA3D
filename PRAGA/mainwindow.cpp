...
{
    PragaSettingsDialog* mySettingsDialog = new PragaSettingsDialog(myProject.pathSetting, myProject.settings, &myProject.gisSettings, myProject.quality, myProject.clima->getElabSettings(), myProject.meteoSettings);
