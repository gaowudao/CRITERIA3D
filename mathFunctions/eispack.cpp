...
/*
  Purpose:
    ...
    BALANC is DUMMY CODE right now.
*/
{
  if ( true )
  {
    printf ( "\n" );
    printf ( "BALANC - Fatal error!\n" );
...
/*
  Purpose:
    ...
    BANDV is DUMMY CODE right now.
*/
{
  if ( true )
  {
    printf ( "\n" );
    printf ( "BANDV - Fatal error!\n" );
    printf ( "  This is just DUMMY CODE right now.\n" );
    exit ( 1 );
  }
  return 0;
...
/*
  Purpose:
    ...
    BISECT is DUMMY CODE right now.
*/
{
  if ( true )
  {
    printf ( "\n" );
    printf ( "BISECT - Fatal error!\n" );
    printf ( "  This is just DUMMY CODE right now.\n" );
    exit ( 1 );
  }
  return 0;
...
/*
  Purpose:
    ...
    CBAL is DUMMY CODE right now.
*/
{
  if ( true )
  {
    printf ( "\n" );
    printf ( "CBAL - Fatal error!\n" );
    printf ( "  This is just DUMMY CODE right now.\n" );
    exit ( 1 );
  }
  return;
...
int cg ( int n, double ar[], double ai[], double wr[], double wi[], bool matz,
  double zr[], double zi[] )
...
/*
  ...
  Discussion:
    ...
    CG calls the recommended sequence of EISPACK routines to find the
    eigenvalues and eigenvectors (if desired) of a complex general matrix.
  ...
  Parameters:
    ...
    Output, int CG, an error completion code described in
...
/*
  Purpose:
    ...
    CINVIT is DUMMY CODE right now.
*/
{
  if ( true )
  {
    printf ( "\n" );
    printf ( "CINVIT - Fatal error!\n" );
    printf ( "  This is just DUMMY CODE right now.\n" );
    exit ( 1 );
  }
  return 0;
...
/*
  Purpose:
    ...
    COMLR2 is DUMMY CODE right now.
*/
{
  if ( true )
  {
    printf ( "\n" );
    printf ( "COMLR2 - Fatal error!\n" );
    printf ( "  This is just DUMMY CODE right now.\n" );
    exit ( 1 );
  }
  return 0;
...
/*
  Purpose:
    ...
    COMQR2 is DUMMY CODE right now.
*/
{
  if ( true )
  {
    printf ( "\n" );
    printf ( "COMQR2 - Fatal error!\n" );
    printf ( "  This is just DUMMY CODE right now.\n" );
    exit ( 1 );
  }
  return 0;
...
/*
  Purpose:
    ...
    HQR2 is DUMMY CODE right now.
*/
{
  if ( true )
  {
    printf ( "\n" );
    printf ( "HQR2 - Fatal error!\n" );
    printf ( "  This is just DUMMY CODE right now.\n" );
    exit ( 1 );
  }
  return 0;
...
/*
  Purpose:
    ...
    MINFIT is DUMMY CODE right now.
*/
{
  if ( true )
  {
    printf ( "\n" );
    printf ( "MINFIT - Fatal error!\n" );
    printf ( "  This is just DUMMY CODE right now.\n" );
    exit ( 1 );
  }
  return 0;
...
/*
  Purpose:
    ...
    QZVAL is DUMMY CODE right now.
*/
{
  if ( true )
  {
    printf ( "\n" );
    printf ( "QZVAL- Fatal error!\n" );
    printf ( "  This is just DUMMY CODE right now.\n" );
    exit ( 1 );
  }
  return;
...
/*
  ...
  Discussion:
    ...
    RG calls the recommended sequence of EISPACK
    routines to find the eigenvalues and eigenvectors (if desired)
  ...
  Parameters:
    ...
    Output, int RG, an error completion code described in
...
/*
  ...
  Discussion:
    ...
    RG_ORT calls the recommended sequence of EISPACK routines to find the
    eigenvalues and eigenvectors (if desired) of a real general matrix,
...
/*
  Purpose:
    ...
    TRIDIB is DUMMY CODE right now.
*/
{
  if ( true )
  {
    printf ( "\n" );
    printf ( "TRIDIB - Fatal error!\n" );
    printf ( "  This is just DUMMY CODE right now.\n" );
    exit ( 1 );
  }
  return 0;
...
/*
  Purpose:
    ...
    TSTURM is DUMMY CODE right now.
*/
{
  if ( true )
  {
    printf ( "\n" );
    printf ( "TSTURM - Fatal error!\n" );
    printf ( "  This is just DUMMY CODE right now.\n" );
    exit ( 1 );
  }
  return 0;
